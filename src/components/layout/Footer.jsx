...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#12110d] border-t border-[#393528] py-12 px-4">
            <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul className="text-sm space-y-2 text-[#bab29c]">
                        {quickLinks.map((link) => (
                            <li key={link.href}>
                ...
                <div>
                    ...
                    <p className="text-sm text-[#bab29c] mb-4">
                    ...
                    <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
                        <input
                            ...
                            className="flex-1 bg-[#27241b] border border-[#393528] rounded-lg text-sm px-3 py-2 text-white"
            ...
            <div className="max-w-screen-xl mx-auto mt-8 pt-8 border-t border-[#393528]">
                <p className="text-center text-sm text-[#bab29c]">
